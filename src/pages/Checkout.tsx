...
export function Checkout({ product, onBack, onPaymentCreated }: CheckoutProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (!paymentEnabled) {
        ...
        console.log('🧪 TEST MODE: Creating order directly...');
        ...
        const orderId = await firestoreService.addOrder({
          ...
          amount_paid: product.discounted_price,
          currency: 'USD',
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <Header onNavigate={(page) => page === 'store' && onBack()} />
            ...
            <div className="bg-gray-900 rounded-lg p-6 sticky top-24">
              ...
              <div className="border-t border-gray-800 pt-4 space-y-3">
                ...
                <div className="flex justify-between text-xl font-bold">
                  <span>Total</span>
                  <span className="text-red-600">${product.discounted_price.toFixed(2)}</span>
                </div>
              </div>
            </div>
          </div>
